...
namespace Microsoft.ML.Tests.Transformers
{
    public class RobustScalerTests : TestDataPipeBase
    {
        ...
        public void TestInvalidType()
        {
            ...
            var pipeline = mlContext.Transforms.RobustScaler("ColA");
        ...
        public void TestNoScale()
        {
            ...
            var pipeline = mlContext.Transforms.RobustScaler("ColA", scale: false);
        ...
        public void TestNoScaleNoCenter()
        {
            ...
            // Build the pipeline, fit, and transform it.
            var pipeline = mlContext.Transforms.RobustScaler("ColA", scale: false, center: false);
            var model = pipeline.Fit(data);
            var output = model.Transform(data);
            var schema = output.Schema;
